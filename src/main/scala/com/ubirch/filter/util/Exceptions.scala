...
object Exceptions {
  ...
  /**
    ...
    */
  abstract class CassandraConnectorServiceException(message: String) extends Exception(message) {
  ...
  /**
    ...
    * @param message Represents the error message.
    */
  case class NoContactPointsException(message: String) extends CassandraConnectorServiceException(message)
  ...
  /**
    ...
    * @param message Represents the error message.
    */
  case class NoKeyspaceException(message: String) extends CassandraConnectorServiceException(message)

  /**
    * Represents an Exception that is thrown when the Consistency Level is invalid.
    * @param message Represents the error message.
    */
  case class InvalidConsistencyLevel(message: String) extends CassandraConnectorServiceException(message)
  ...
  /**
    ...
    * @param message Represents the error message.
    */
  case class InvalidContactPointsException(message: String) extends CassandraConnectorServiceException(message)
